...
// Security check for table browser
if ($table && !in_array($table, $allowed_tables)) {
    die("Invalid table selected.");
}

// Security check for demo query links
...
<head>
    ...
    <style>
        ...
        h1 { color: #2f5d3a; }
        h2 { margin-top: 30px; }
        a { text-decoration: none; color: #2f5d3a; font-weight: bold; }
